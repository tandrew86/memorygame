$(document).ready(function () {
    var greetingPanel = $('#greetingPanel'),
        ...
        categoryFruitsPictures = [
          '<img src="public_html/Pics/Fru/fru1.jpg" alt="fru1" class="img img-responsive"/>',
          '<img src="public_html/Pics/Fru/fru2.jpg" alt="fru2" class="img img-responsive"/>',
          '<img src="public_html/Pics/Fru/fru3.jpg" alt="fru3" class="img img-responsive"/>',
          '<img src="public_html/Pics/Fru/fru4.jpg" alt="fru4" class="img img-responsive"/>',
          '<img src="public_html/Pics/Fru/fru5.jpg" alt="fru5" class="img img-responsive"/>',
          '<img src="public_html/Pics/Fru/fru6.jpg" alt="fru6" class="img img-responsive"/>',
          '<img src="public_html/Pics/Fru/fru7.jpg" alt="fru7" class="img img-responsive"/>',
          '<img src="public_html/Pics/Fru/fru8.jpg" alt="fru8" class="img img-responsive"/>',
          '<img src="public_html/Pics/Fru/fru9.jpg" alt="fru9" class="img img-responsive"/>',
          '<img src="public_html/Pics/Fru/fru10.jpg" alt="fru10" class="img img-responsive"/>',
          '<img src="public_html/Pics/Fru/fru11.jpg" alt="fru11" class="img img-responsive"/>',
          '<img src="public_html/Pics/Fru/fru12.jpg" alt="fru12" class="img img-responsive"/>'
        ],
        categoryVegetablesPictures = [
          '<img src="public_html/Pics/Veg/veg1.jpg" alt="veg1" class="img img-responsive"/>',
          '<img src="public_html/Pics/Veg/veg2.jpg" alt="veg2" class="img img-responsive"/>',
          '<img src="public_html/Pics/Veg/veg3.jpg" alt="veg3" class="img img-responsive"/>',
          '<img src="public_html/Pics/Veg/veg4.jpg" alt="veg4" class="img img-responsive"/>',
          '<img src="public_html/Pics/Veg/veg5.jpg" alt="veg5" class="img img-responsive"/>',
          '<img src="public_html/Pics/Veg/veg6.jpg" alt="veg6" class="img img-responsive"/>',
          '<img src="public_html/Pics/Veg/veg7.jpg" alt="veg7" class="img img-responsive"/>',
          '<img src="public_html/Pics/Veg/veg8.jpg" alt="veg8" class="img img-responsive"/>',
          '<img src="public_html/Pics/Veg/veg9.jpg" alt="veg9" class="img img-responsive"/>',
          '<img src="public_html/Pics/Veg/veg10.jpg" alt="veg10" class="img img-responsive"/>',
          '<img src="public_html/Pics/Veg/veg11.jpg" alt="veg11" class="img img-responsive"/>',
          '<img src="public_html/Pics/Veg/veg12.jpg" alt="veg12" class="img img-responsive"/>'
        ],
